  ...
  const faqs = [
    {
      ...
      answer:
        'HomeChef is a recipe platform where you can discover, explore, and cook delicious meals with step-by-step instructions.'
    },
    {
      question: 'Is HomeChef free to use?',
      answer:
        'Yes, HomeChef is completely free. You can access all recipes and features at no cost.'
    },
    {
      question: 'Are the recipes beginner-friendly?',
      answer:
        'Yes, our recipes are designed for all skill levels, with clear step-by-step instructions.'
    },
    {
      question: 'Can I search by the ingredients I have?',
      answer:
        'Absolutely! Use the "Search by Ingredients" feature to find recipes that match what’s in your kitchen.'
    },
    {
          ...
          <div className={style.faq_container1}>
            {faqs.map((faq, index) => (
              ...
              >
                ...
                {openIndex === index && (
                  <p className={style.faq_text}>{faq.answer}</p>
                )}
              </div>
            ))}
          </div>
